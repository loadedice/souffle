...
".i8_type"                            { return yy::parser::make_I8_TYPE(yylloc); }
".i16_type"                           { return yy::parser::make_I16_TYPE(yylloc); }
".i32_type"                           { return yy::parser::make_I32_TYPE(yylloc); }
".i64_type"                           { return yy::parser::make_I64_TYPE(yylloc); }
".u8_type"                            { return yy::parser::make_U8_TYPE(yylloc); }
".u16_type"                           { return yy::parser::make_U16_TYPE(yylloc); }
".u32_type"                           { return yy::parser::make_U32_TYPE(yylloc); }
